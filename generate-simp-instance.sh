...
lower=${9:-0}
upper=${10:-0}
edge_b=${11:-0} #lower bound on triangles per blue edge
Edge_b=${12:-0} #upper bound on triangles per blue edge
edge_r=${13:-0} #lower bound on triangles per red edge
Edge_r=${14:-0} 

if [ -f constraints_${n}_${p}_${q}_${lower}_${upper}_${edge_b}_${Edge_b}_${edge_r}_${Edge_r}_${t}_${s}_${b}_${r}_${a}_final.simp ]
then
...
./1-instance-generation.sh $n $p $q $lower $upper ${edge_b} ${Edge_b} ${edge_r} ${Edge_r}

instance_tracking=constraints_${n}_${p}_${q}_${lower}_${upper}_${edge_b}_${Edge_b}_${edge_r}_${Edge_r}

echo $instance_tracking

if [ "$s" -eq 1 ] || [ "$s" -eq 3 ]
then
    simp1=constraints_${n}_${p}_${q}_${lower}_${upper}_${edge_b}_${Edge_b}_${edge_r}_${Edge_r}_${t}_${s}_${b}_${r}_${a}.simp1 
    cp $instance_tracking constraints_${n}_${p}_${q}_${lower}_${upper}_${edge_b}_${Edge_b}_${edge_r}_${Edge_r}_${t}_${s}_${b}_${r}_${a}

    if [ -f $simp1 ]
    then
        echo "$simp1 already exist, skip simplification"
    else
        ./simplification/simplify-by-conflicts.sh constraints_${n}_${p}_${q}_${lower}_${upper}_${edge_b}_${Edge_b}_${edge_r}_${Edge_r}_${t}_${s}_${b}_${r}_${a} $n $t
        mv constraints_${n}_${p}_${q}_${lower}_${upper}_${edge_b}_${Edge_b}_${edge_r}_${Edge_r}_${t}_${s}_${b}_${r}_${a}.simp $simp1
        rm constraints_${n}_${p}_${q}_${lower}_${upper}_${edge_b}_${Edge_b}_${edge_r}_${Edge_r}_${t}_${s}_${b}_${r}_${a}
...
simp_non=constraints_${n}_${p}_${q}_${lower}_${upper}_${edge_b}_${Edge_b}_${edge_r}_${Edge_r}_${t}_${s}_${b}_${r}_${a}.noncanonical
...
if [ "$s" -eq 2 ] || [ "$s" -eq 3 ]
simp2=constraints_${n}_${p}_${q}_${lower}_${upper}_${edge_b}_${Edge_b}_${edge_r}_${Edge_r}_${t}_${s}_${b}_${r}_${a}.simp2
then
    if [ -f $simp2 ]
    then
...
echo "preprocessing complete. final instance is $instance_tracking. Renaming it as constraints_${n}_${p}_${q}_${lower}_${upper}_${edge_b}_${Edge_b}_${edge_r}_${Edge_r}_${t}_${s}_${b}_${r}_${a}_final.simp"

mv $instance_tracking constraints_${n}_${p}_${q}_${lower}_${upper}_${edge_b}_${Edge_b}_${edge_r}_${Edge_r}_${t}_${s}_${b}_${r}_${a}_final.simp
