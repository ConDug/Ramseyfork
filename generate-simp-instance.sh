...
if [ "$s" -eq 2 ] || [ "$s" -eq 3 ]
simp2=constraints_${n}_${p}_${q}_${lower}_${upper}_${Edge_b}_${Edge_r}_${t}_${s}_${b}_${r}_${a}.simp2
then
    if [ -f $simp2 ]
    then
...
echo "preprocessing complete. final instance is $instance_tracking. Renaming it as constraints_${n}_${p}_${q}_${lower}_${upper}_${Edge_b}_${Edge_r}_${t}_${s}_${b}_${r}_${a}_final.simp"

mv $instance_tracking constraints_${n}_${p}_${q}_${lower}_${upper}_${Edge_b}_${Edge_r}_${t}_${s}_${b}_${r}_${a}_final.simp
