...
if [ -f constraints_${n}_${p}_${q}_${l}_${u}_${l_e_b}_${u_e_b}_${l_e_r}_${u_e_r} ]
then
    echo "instance already generated"
else
    python3 gen_instance/generate.py $n $p $q $l $u ${l_e_b} ${u_e_b} ${l_e_r} ${u_e_r} #generate the instance of order n for p,q
fi
